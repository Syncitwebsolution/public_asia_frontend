                ...
                <div className="flex items-end justify-between gap-4 mt-2 relative">
                  ...
                  <div className="relative">
                    ...
                    {activeShareId === heroArticle._id && (
                      <div className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-100 p-2 flex flex-col gap-1 z-[100] animate-in fade-in zoom-in-95 duration-200 min-w-[140px] origin-top-right">
                      ...
                      <div className="flex items-center justify-between mt-2 relative">
                        ...
                        <div className="relative">
                          ...
                          {activeShareId === item._id && (
                            <div className="absolute right-0 top-full mt-2 bg-white rounded-lg shadow-xl border border-gray-100 p-2 flex flex-col gap-1 z-[100] animate-in fade-in zoom-in-95 duration-200 min-w-[140px] origin-top-right">
