                  ...
                  <div className="relative">
                    ...
                    {activeShareId === heroArticle._id && (
                      <div 
                        ...
                        className="fixed bg-white rounded-lg shadow-2xl border border-gray-100 p-2 flex flex-col gap-1 z-[9999] animate-in fade-in zoom-in-95 duration-200 min-w-[140px] origin-top-right"
                      >
