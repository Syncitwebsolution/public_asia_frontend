                ...
                <div className="flex items-end justify-between gap-4 mt-2 relative">
                  ...
                  <div className="relative">
                    ...
                    {activeShareId === heroArticle._id && (
                      <div className="absolute bottom-full right-0 mb-2 bg-white rounded-lg shadow-xl border border-gray-100 p-2 flex flex-col gap-1 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
                      ...
                      <div className="flex items-center justify-between mt-2 relative">
                        ...
                        <div className="relative">
                          ...
                          {activeShareId === item._id && (
                            <div className="absolute bottom-full right-0 mb-2 bg-white rounded-lg shadow-xl border border-gray-100 p-2 flex flex-col gap-1 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200 min-w-[120px]">
