...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="md:hidden border-b bg-white/80 backdrop-blur-md sticky top-14 z-50">
        <NewsCatagory horizontal />
      </div>

      <div className="flex max-w-7xl mx-auto px-2 md:px-4 flex-col lg:flex-row gap-6 py-4 overflow-x-hidden">

        {/* Left Sidebar */}
        <div className="hidden lg:block lg:w-60 shrink-0">
          <div ref={leftSidebarRef} className="sticky z-10 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden" style={{ top: '80px' }}>
            <div className="bg-gradient-to-r from-red-600 to-red-700 text-white px-4 py-3">
              <h3 className="text-sm text-center font-bold uppercase tracking-widest">कैटेगरी</h3>
            </div>
            <NewsCatagory />
          </div>
        </div>
        ...
        {/* Main Content */}
        <div className="flex flex-1 gap-6 min-h-screen">
