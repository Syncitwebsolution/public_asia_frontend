      ...
      <article className="max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white rounded-2xl shadow-sm border border-gray-100 mb-12 flex-grow">
        ...
        <header className="border-b pb-8 mb-10 text-center">
          ...
          <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
            सच्चाई, निष्पक्षता और निडर पत्रकारिता — Public Asia में आपका स्वागत है।
          </p>
        </header>
        ...
        <section className="prose max-w-none text-gray-700 leading-relaxed space-y-10">
          ...
          {/* Introduction */}
          <div>
            <p className="text-xl font-medium text-gray-800 border-l-4 border-red-600 pl-4">
              <strong>Public Asia</strong> भारत और दुनिया भर की ताज़ा खबरों, गहन विश्लेषण, और निष्पक्ष रिपोर्टिंग के लिए आपका सबसे भरोसेमंद स्रोत है। हमारा मिशन हर नागरिक तक सच्ची और सटीक जानकारी पहुँचाना है।
            </p>
          </div>
          ...
          {/* Contact CTA */}
          <div className="bg-gray-950 text-white p-8 rounded-2xl text-center mt-12 shadow-xl">
            ...
            <a href="/contact" className="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-10 rounded-xl transition-all duration-300 shadow-lg shadow-red-600/20 active:scale-95">
